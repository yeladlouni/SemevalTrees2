...
public abstract class DataReader extends Resource_ImplBase {
	...
	public static final String INSTANCE_D_TASK = "instance_d";
	...
	public void afterResourcesInitialized() throws ResourceInitializationException {
		try {
			if (!task.matches(INSTANCE_A_TASK+"|"+INSTANCE_B_TASK+"|"+INSTANCE_C_TASK+"|"+INSTANCE_D_TASK))
	...
	public abstract String next() throws ResourceProcessException;
